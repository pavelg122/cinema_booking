    ...
    <footer className="bg-secondary-950 text-secondary-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm mb-4">
              Your premium cinema experience with the latest movies, comfortable seats, and state-of-the-art sound systems.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-secondary-400 hover:text-primary-500 transition-colors">Home</Link>
              </li>
              <li>
                <Link to="/movies" className="text-secondary-400 hover:text-primary-500 transition-colors">Movies</Link>
              </li>
              <li>
                <Link to="/register" className="text-secondary-400 hover:text-primary-500 transition-colors">Sign Up</Link>
              </li>
              <li>
                <Link to="/login" className="text-secondary-400 hover:text-primary-500 transition-colors">Login</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-secondary-800 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} CineMax Cinemas. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
